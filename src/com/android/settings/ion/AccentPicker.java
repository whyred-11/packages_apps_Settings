...
package com.android.settings.ion;
...
public class AccentPicker extends InstrumentedDialogFragment implements OnClickListener {
    ...
    private boolean isUsingDarkTheme() {
        ...
        try {
            themeInfo = mOverlayManager.getOverlayInfo("com.android.system.theme.dark.ion",
    ...
    private boolean isUsingBlackTheme() {
        OverlayInfo themeInfo = null;
        try {
            themeInfo = mOverlayManager.getOverlayInfo("com.android.system.theme.black.ion",
                    UserHandle.USER_CURRENT);
        } catch (RemoteException e) {
            e.printStackTrace();
        }
